                    ...
                    <div className="ct_scan_contant">
                        <div className="ct_scan_left">
                            ...
                            <div className="left-btn">
                                <button className='btn_ct_scan'>Book Your Scan <FiArrowUpRight size={20} className='icon_ct_scan'/></button>
                                <button className='btn_ct_scan'>Call Us <FaPhoneVolume size={20} id='icon_ct_scan1' className='icon_ct_scan'/></button>
                            </div>
                        </div>
                        <div className="ct_scan_right">
